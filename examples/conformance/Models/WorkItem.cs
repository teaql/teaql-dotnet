    ...
    public class WorkItem
    {
        ...
        internal void TeaqlPreflightGraph(UserContext context)
        {
            ...
            if (!creating && !_markedForDeletion)
            {
                ...
                if (!IsLoaded("Title"))
                    throw new CheckException(new[] { new CheckResult { RuleId = "invalid_type", Location = ObjectLocation.Property("title"), Message = "Mutation requires a fully loaded entity" } });
